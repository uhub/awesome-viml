...
* [mhinz/vim-startify](https://github.com/mhinz/vim-startify) - A fancy start screen for Vim.
...
* [justinmk/vim-sneak](https://github.com/justinmk/vim-sneak) - :shoe: The missing motion for Vim
...
* [esneider/YUNOcommit.vim](https://github.com/esneider/YUNOcommit.vim) - Y U NO commit after so many writes???
...
* [ryanoasis/vim-devicons](https://github.com/ryanoasis/vim-devicons) - :symbols: adds font icons (glyphs ★♨☢) to programming languages, libraries, and web developer filetypes for: NERDTree, vim-airline, ctrlp, unite, lightline.vim, vimfiler, and flagship
...
* [sickill/vim-monokai](https://github.com/sickill/vim-monokai) - Monokai color scheme for Vim converted with coloration.ku1ik.com from Textmate theme with the same name.
...
* [reedes/vim-colors-pencil](https://github.com/reedes/vim-colors-pencil) - Light (& dark) color scheme inspired by iA Writer
...
* [ervandew/screen](https://github.com/ervandew/screen) - Simulate a split shell in vim using gnu screen or tmux
...
* [edsono/vim-matchit](https://github.com/edsono/vim-matchit) - A git repository for a vim plugin called matchit
...
* [saihoooooooo/glowshi-ft.vim](https://github.com/saihoooooooo/glowshi-ft.vim) - improve movement of f/t with glow shift.
...
* [mitsuhiko/vim-python-combined](https://github.com/mitsuhiko/vim-python-combined) - Fork of the python.vim by Dmitry Vasiliev and Neil Schemenauer for 2.x and 3.x.
* [maciakl/vim-neatstatus](https://github.com/maciakl/vim-neatstatus) - Neat Status Line Plugin for Vim
* [koron/minimap-vim](https://github.com/koron/minimap-vim) - Minimap for Vim
...
* [dreadatour/dotfiles](https://github.com/dreadatour/dotfiles) - dotfiles
* [chrisbra/Colorizer](https://github.com/chrisbra/Colorizer) - color hex codes and color names
* [bruno-/vim-man](https://github.com/bruno-/vim-man) - View and grep man pages in vim
* [tsaleh/vim-align](https://github.com/tsaleh/vim-align) - Clone of the Align.vba file, since I think VBA files are a freaking abomination.
* [tpope/vim-heroku](https://github.com/tpope/vim-heroku) - heroku.vim: Heroku toolbelt and hk wrapper
...
* [othree/html5-syntax.vim](https://github.com/othree/html5-syntax.vim) - HTML5 syntax file for vim.
* [mattn/vdbi-vim](https://github.com/mattn/vdbi-vim) - Database client for Vim
* [junegunn/vim-oblique](https://github.com/junegunn/vim-oblique) - Improved /-search (experimental)
...
* [t9md/vim-transform](https://github.com/t9md/vim-transform) - Transform syntax!!
* [jlong/rubyblue](https://github.com/jlong/rubyblue) - A collection of themes for different text editors that mimic the colors used in the code samples on ruby-lang.org
* [jeffbuttars/Vimdown](https://github.com/jeffbuttars/Vimdown) - A dirty tool to convert .vimrc and .vim script files to markdown
* [edkolev/erlang-motions.vim](https://github.com/edkolev/erlang-motions.vim) - Motions and text objects for erlang!
...
* [shykes/devbox](https://github.com/shykes/devbox) - Solomon's dev environment
* [paradigm/SkyBison](https://github.com/paradigm/SkyBison) - Vim plugin to expedite use of cmdline commands
* [evanmiller/nginx-vim-syntax](https://github.com/evanmiller/nginx-vim-syntax) - nginx vim syntax. Copied from http://www.vim.org/scripts/script.php?script_id=1886
* [edgecase/vim-config](https://github.com/edgecase/vim-config) - This is the Vim configuration we use on pairing machines at EdgeCase, as well as many personal machines. It's pretty okay.
* [ahw/vim-hooks](https://github.com/ahw/vim-hooks) - Easily hook shell scripts into Vim autocmd events.
* [aereal/dotfiles](https://github.com/aereal/dotfiles) - My config files.
...
* [vim-scripts/bufkill.vim](https://github.com/vim-scripts/bufkill.vim) - Unload/delete/wipe a buffer, keep its window(s), display last accessed buffer(s)
* [venantius/vim-cljfmt](https://github.com/venantius/vim-cljfmt) - A Vim plugin for cljfmt, the Clojure formatting tool.
* [trapd00r/neverland-vim-theme](https://github.com/trapd00r/neverland-vim-theme) - 256 colors CLI and GUI. It doesn't suck.
* [t9md/vim-textmanip](https://github.com/t9md/vim-textmanip) - easy text manupilation for vim
* [leshill/vim-json](https://github.com/leshill/vim-json) - Syntax highlighting for JSON in Vim
...
* [haridas/Dotfiles](https://github.com/haridas/Dotfiles) - My .vim .bashrc and .vimrc files
...
* [adamhjk/adam-vim](https://github.com/adamhjk/adam-vim) - My vim directory
...
* [simmel/vim-pastie](https://github.com/simmel/vim-pastie) - pastie.vim: interface for pastie.org
* [rdlugosz/dotfiles](https://github.com/rdlugosz/dotfiles) - Ryan's Yak Shaving Empire and Bike Sheddery…
* [itchyny/landscape.vim](https://github.com/itchyny/landscape.vim) - A colorscheme and syntax for Vim
* [Zuckonit/vim-airline-tomato](https://github.com/Zuckonit/vim-airline-tomato) - Pomodoro Technique
* [Dinduks/vim-holylight](https://github.com/Dinduks/vim-holylight) - A Vim plugin for MacBook users that automatically sets the background to light or dark depending on the ambient light
...
* [mhinz/vim-sayonara](https://github.com/mhinz/vim-sayonara) - Sane buffer/window deletion.
...
* [windy/ruby-vimrc](https://github.com/windy/ruby-vimrc) - A quick vimrc for Ruby on Rails programming
...
* [dougireton/mirror_pond](https://github.com/dougireton/mirror_pond) - An opinionated Vim distribution for Ruby and Chef development
...
* [nelstrom/vim-mac-classic-theme](https://github.com/nelstrom/vim-mac-classic-theme) - A port of the Mac Classic theme from TextMate to Vim. Because everyone needs a decent light theme for special occasions.
...
* [basyura/unite-rails](https://github.com/basyura/unite-rails) - a unite.vim plugin for rails
* [JulesWang/css.vim](https://github.com/JulesWang/css.vim) - Cutting-edge vim css syntax file
* [zerowidth/vim-copy-as-rtf](https://github.com/zerowidth/vim-copy-as-rtf) - Copy syntax-highlighted code from vim to the OS X clipboard as RTF text
...
* [wesgibbs/vim-irblack](https://github.com/wesgibbs/vim-irblack) - Infinite Red's ir_black vim theme packaged to work with Tim Pope's pathogen plugin.
* [vim-scripts/vcscommand.vim](https://github.com/vim-scripts/vcscommand.vim) - CVS/SVN/SVK/git/hg/bzr integration plugin
* [vim-scripts/tComment](https://github.com/vim-scripts/tComment) - An extensible & universal comment plugin that also handles embedded filetypes
* [vim-scripts/nginx.vim](https://github.com/vim-scripts/nginx.vim) - initial version
...
* [parkr/vim-jekyll](https://github.com/parkr/vim-jekyll) - Fork of psykidellic/vim-jekyll because actually forking it freaks out
* [osyo-manga/vim-precious](https://github.com/osyo-manga/vim-precious) - Vim constext filetype
* [justinmk/vim-syntax-extra](https://github.com/justinmk/vim-syntax-extra) - Vim syntax highlighting for c, bison, flex
* [jm3/dotfiles](https://github.com/jm3/dotfiles) - :beginner: Smart vim + zsh dotfiles with easy install + updating
* [dotphiles/dotvim](https://github.com/dotphiles/dotvim) - A community driven framework for vim
* [chreekat/vim-paren-crosshairs](https://github.com/chreekat/vim-paren-crosshairs) - [Abandoned -- see below]
...
* [vim-scripts/camelcasemotion](https://github.com/vim-scripts/camelcasemotion) - Motion through CamelCaseWords and underscore_notation.
* [vim-scripts/argtextobj.vim](https://github.com/vim-scripts/argtextobj.vim) - Text-object like motion for arguments
* [thinca/vim-themis](https://github.com/thinca/vim-themis) - A testing framework for Vim script.
* [osyo-manga/vim-brightest](https://github.com/osyo-manga/vim-brightest) - highlight cursor word
* [oblitum/rainbow](https://github.com/oblitum/rainbow) - Rainbow Parentheses Improved
* [mattn/calendar-vim](https://github.com/mattn/calendar-vim) - calendar vimscript
* [john2x/flatui.vim](https://github.com/john2x/flatui.vim) - Vim colorscheme based on flatuicolors.com
...
* [baskerville/bubblegum](https://github.com/baskerville/bubblegum) - A vim color scheme based on xoria256
* [adinapoli/vim-markmultiple](https://github.com/adinapoli/vim-markmultiple) - An emacs-like mark multiple plugin
* [Twinside/vim-haskellConceal](https://github.com/Twinside/vim-haskellConceal) - Conceal operator for haskell
* [vim-scripts/pep8](https://github.com/vim-scripts/pep8) - Check your python source files with PEP8
...
* [troydm/easybuffer.vim](https://github.com/troydm/easybuffer.vim) - easybuffer.vim - vim plugin to quickly switch between buffers
* [tpope/vim-rbenv](https://github.com/tpope/vim-rbenv) - rbenv.vim: Minimal rbenv support
* [tmux-plugins/vim-tmux](https://github.com/tmux-plugins/vim-tmux) - vim plugin for tmux.conf
* [luofei614/vim-plug](https://github.com/luofei614/vim-plug) - 我的vim插件， 基于vim-plug安装
* [kballard/vim-swift](https://github.com/kballard/vim-swift) - Swift filetype plugin for Vim
* [ingydotnet/yaml-vim](https://github.com/ingydotnet/yaml-vim) - YAML Highlight script for VIM editor
* [hhvm/vim-hack](https://github.com/hhvm/vim-hack) - Syntax highlighting and typechecker integration for Hack.
* [fugalh/desert.vim](https://github.com/fugalh/desert.vim) - desert colorscheme
* [Olical/vim-enmasse](https://github.com/Olical/vim-enmasse) - Edit every file in a quickfix list at the same time
* [wnodom/wnodom-vim-environment](https://github.com/wnodom/wnodom-vim-environment) - Bill Odom's Vim Environment
* [vim-latex/vim-latex](https://github.com/vim-latex/vim-latex) - Enhanced LaTeX support for Vim
* [timcharper/textile.vim](https://github.com/timcharper/textile.vim) - Textile for VIM
* [mitsuhiko/fruity-vim-colorscheme](https://github.com/mitsuhiko/fruity-vim-colorscheme) - Fruity Colorscheme for Vim
* [kaochenlong/eddie-vim2](https://github.com/kaochenlong/eddie-vim2) - Yet another vimrc
* [jperras/vim-dotfiles](https://github.com/jperras/vim-dotfiles) - Carefully crafted, curated and language-agnostic Vim development environment
* [jgdavey/vim-blockle](https://github.com/jgdavey/vim-blockle) - Brace yourself, it's time to toggle your ruby blocks!
...
* [everzet/dotfiles](https://github.com/everzet/dotfiles) - everzet (life|work) dotfiles
* [diracdeltas/dotfiles](https://github.com/diracdeltas/dotfiles) - Useful config-related files
* [MarcWeber/vim-addon-async](https://github.com/MarcWeber/vim-addon-async) - This plugin will provide different async communication implementations
* [rbtnn/rabbit-ui.vim](https://github.com/rbtnn/rabbit-ui.vim) - Rich UI Vim script Library
* [phallus/arch-files](https://github.com/phallus/arch-files) - dotfiles
* [neowit/vim-force.com](https://github.com/neowit/vim-force.com) - Vim plugin for force.com
...
* [jaxbot/selective-undo.vim](https://github.com/jaxbot/selective-undo.vim) - Selective undo for Vim
...
* [gorkunov/smartgf.vim](https://github.com/gorkunov/smartgf.vim) - Vim 'goto file' on steroids!
* [dahu/vimple](https://github.com/dahu/vimple) - Develop VimL
* [dahu/SearchParty](https://github.com/dahu/SearchParty) - Extended search commands and maps for Vim
* [Leeiio/Vim](https://github.com/Leeiio/Vim) - My vimrc for Macvim.
* [vim-scripts/EasyGrep](https://github.com/vim-scripts/EasyGrep) - Fast and Easy Find and Replace Across Multiple Files
* [t9md/vim-quickhl](https://github.com/t9md/vim-quickhl) - quickly highlight <cword> or visually selected word
* [samvit/dotvim](https://github.com/samvit/dotvim) - my vim config
...
* [justincampbell/vim-eighties](https://github.com/justincampbell/vim-eighties) - Automatically resizes your windows
* [jaxbot/vimfiles](https://github.com/jaxbot/vimfiles) - vim, tmux, zsh
...
* [Bogdanp/rbrepl.vim](https://github.com/Bogdanp/rbrepl.vim) - VIM plugin that allows you to run a Ruby REPL inside a VIM buffer.
* [vim-scripts/LanguageTool](https://github.com/vim-scripts/LanguageTool) - Grammar checker for English, French, German (etc.) in Vim
* [typedclojure/vim-typedclojure](https://github.com/typedclojure/vim-typedclojure) - The Typed Clojure plugin for Vim + vim-fireplace
* [t9md/vim-smalls](https://github.com/t9md/vim-smalls) - spot your cursor with simple search
* [sudar/vim-arduino-syntax](https://github.com/sudar/vim-arduino-syntax) - Arduino syntax files for Vim
* [spastorino/vinimum](https://github.com/spastorino/vinimum) - My vim distribution
* [noahfrederick/vim-noctu](https://github.com/noahfrederick/vim-noctu) - A Vim color scheme for 16-color terminals
* [kmnk/vim-unite-giti](https://github.com/kmnk/vim-unite-giti) - unite source for using git
...
* [fbeeper/fMacVim](https://github.com/fbeeper/fMacVim) - MacVim + essential plugins + my custom (and awesome) .vimrc
* [farazdagi/vim-go-ide](https://github.com/farazdagi/vim-go-ide) - Ready to use, fully configured for Go development.
* [Wutzara/vim-materialtheme](https://github.com/Wutzara/vim-materialtheme) - Material Theme, the vim adaption by Günther Wutz
* [Anthony1234567/Vimrc1234567](https://github.com/Anthony1234567/Vimrc1234567) - Personalized vimrc with C++, Markdown, and text editing at its core.
* [zhenlonghe/zhenlong-vimrc](https://github.com/zhenlonghe/zhenlong-vimrc) - zhenlong own vimrc
* [toritori0318/vim-redmine](https://github.com/toritori0318/vim-redmine) - Redmine operation from vim
* [skwp/greplace.vim](https://github.com/skwp/greplace.vim) - Global search and replace for VI
* [pct/pct.vim](https://github.com/pct/pct.vim) - pct's vim files
* [nono/github_vim_theme](https://github.com/nono/github_vim_theme) - Github Theme for ViM
* [linhmtran168/mac_dotfiles](https://github.com/linhmtran168/mac_dotfiles) - My Mac dot files
...
* [codegram/vimfiles](https://github.com/codegram/vimfiles) - Codegram vimfiles
...
* [chloerei/vimrc](https://github.com/chloerei/vimrc) - my vimrc deploy backup
* [beiyuu/vimfiles](https://github.com/beiyuu/vimfiles) - BeiYuu's VIM Setup
* [xuxiaodong/vimenv](https://github.com/xuxiaodong/vimenv) - Configure Vim environment
* [wesleyche/Trinity](https://github.com/wesleyche/Trinity) - A (G)Vim plugin which build the trinity of Source Explorer, TagList and NERD tree to be an IDE for software development.
* [vim-scripts/JavaScript-Indent](https://github.com/vim-scripts/JavaScript-Indent) - Javascript indenter (HTML indent is included)
* [vim-php/vim-php-refactoring](https://github.com/vim-php/vim-php-refactoring) - PHP Refactoring support for VIM
* [ttsiodras/dotvim](https://github.com/ttsiodras/dotvim) - My .vim folder (plugins and settings)
...
* [kongo2002/fsharp-vim](https://github.com/kongo2002/fsharp-vim) - Vim runtime files for F# (fsharp)
* [joonty/myvim](https://github.com/joonty/myvim) - My personal Vim configuration
* [honza/dockerfile.vim](https://github.com/honza/dockerfile.vim) - Syntax highlighting for Dockerfiles
* [hallison/vim-ruby-sinatra](https://github.com/hallison/vim-ruby-sinatra) - Vim syntax highlight and snippets that helper coding applications based in Sinatra micro-framework.
* [fncll/vimstuff](https://github.com/fncll/vimstuff) - Various bits and pieces that work with Vim
* [bronson/vim-visual-star-search](https://github.com/bronson/vim-visual-star-search) - Start a * or # search from a visual block
* [bramblex/BlxVimrc](https://github.com/bramblex/BlxVimrc) - My vimrc
* [asins/vimcdoc](https://github.com/asins/vimcdoc) - Vim Chinese Documentation
* [andrew8088/dotfiles](https://github.com/andrew8088/dotfiles) - My dotfiles (currently for git, vim, and zsh)
* [adoy/vim-php-refactoring-toolbox](https://github.com/adoy/vim-php-refactoring-toolbox) - VIM Php Refactoring Toolbox
* [adamlowe/vim-slurper](https://github.com/adamlowe/vim-slurper) - Vim script for slurper gem to provide file specific syntax highlighting and key mappings.
* [wannesm/wmgraphviz.vim](https://github.com/wannesm/wmgraphviz.vim) - Vim plugin for Graphviz
* [vim-scripts/The-NERD-tree](https://github.com/vim-scripts/The-NERD-tree) - A tree explorer plugin for navigating the filesystem
* [tyru/caw.vim](https://github.com/tyru/caw.vim) - sophisticated comment plugin
* [srushti/vim-get](https://github.com/srushti/vim-get) - Vim setup with special focus on Ruby/Rails development, with the ability to quickly get latest on all your plugins.
* [rhysd/dotfiles](https://github.com/rhysd/dotfiles) - My dotfiles
* [r7kamura/dotfiles](https://github.com/r7kamura/dotfiles) - A chain of configurations for my laptop.
* [malkomalko/projections.vim](https://github.com/malkomalko/projections.vim) - projections adapted from rails.vim
* [jceb/vimrc](https://github.com/jceb/vimrc) - Vim configuration optimized for productive text editing
* [beberlei/vim-php-refactor](https://github.com/beberlei/vim-php-refactor) - Some simple vim refactoring functions for your PHP code
* [artemave/slowdown.vim](https://github.com/artemave/slowdown.vim) - Slows down vim
* [MaxSt/FlatColor](https://github.com/MaxSt/FlatColor) - FlatColor vim colorscheme
* [vim-scripts/perl-support.vim](https://github.com/vim-scripts/perl-support.vim) - Perl IDE -- Write and run Perl-scripts using menus and hotkeys.
...
* [msanders/vim-files](https://github.com/msanders/vim-files) - The configuration files & plugins I use with Vim.
...
* [happypeter/peter-vim](https://github.com/happypeter/peter-vim) - My  ~/.vim/
* [drmikehenry/vim-fixkey](https://github.com/drmikehenry/vim-fixkey) - https://github.com/drmikehenry/
* [drewolson/ruby_focused_unit_test_vim](https://github.com/drewolson/ruby_focused_unit_test_vim) - run a focused ruby unit test in vim
* [dahu/VimRegexTutor](https://github.com/dahu/VimRegexTutor) - A vimtutor clone for learning Regular Expressions in Vim
...
* [0x0dea/vim-molasses](https://github.com/0x0dea/vim-molasses) - Punish yourself (and/or your friends/enemies) for inefficiently using Vim.
...
* [timthrillist/minimum-awesome](https://github.com/timthrillist/minimum-awesome) - A Vim setup that will get you into Vim and make it so that you don't want to pull your hair out.
* [tempire/dotvim](https://github.com/tempire/dotvim) - dotvim, .vimrc
* [stephpy/vim-config](https://github.com/stephpy/vim-config) - My vim config
* [solars/github-vim](https://github.com/solars/github-vim) - vim plugin to use github-tmbundle magic
* [sk1418/Join](https://github.com/sk1418/Join) - a better (hopefully) :Join command in vim
* [nviennot/vim-config](https://github.com/nviennot/vim-config) - The Vim config I use
* [nvie/vim-pep8](https://github.com/nvie/vim-pep8) - This project is superseded by vim-flake8!
* [na/django-vim](https://github.com/na/django-vim) - A set of vim plugins and settings for using vim to develop django.
* [mfukar/robotframework-vim](https://github.com/mfukar/robotframework-vim) - Some vim scripts for use with the Robot framework.
...
* [drewolson/vim_dotfiles](https://github.com/drewolson/vim_dotfiles) - my vim dotfiles
* [crusoexia/vim-monokai](https://github.com/crusoexia/vim-monokai) - Refined Monokai color scheme for vim
* [coot/atp_vim](https://github.com/coot/atp_vim) - Automatic LaTeX Plugin is one of the leading LaTeX plugin for Vim
...
* [robconery/vim-settings](https://github.com/robconery/vim-settings) - My vim action
* [qrush/vim-fu](https://github.com/qrush/vim-fu) - Combining the awesomeness of various vim plugins in one easy configurable unit.
* [nojhan/dotfiles](https://github.com/nojhan/dotfiles) - My config files
* [moznion/hateblo.vim](https://github.com/moznion/hateblo.vim) - This plugin provides some functions of Hatena-Blog by using AtomPub API.
* [mklabs/grunt.vim](https://github.com/mklabs/grunt.vim) - Vim plugin with support for Grunt
* [hobbestigrou/vimtips-fortune](https://github.com/hobbestigrou/vimtips-fortune) - A vimtips to fortune software.
* [gcmt/taboo.vim](https://github.com/gcmt/taboo.vim) - Few utilities for pretty tabs
* [fsouza/go.vim](https://github.com/fsouza/go.vim) - Go support on Vim (based on ${GOROOT}/misc/vim), with omnicompletion provided by gocode.
* [davidbeckingsale/writegood.vim](https://github.com/davidbeckingsale/writegood.vim) - Vim plugin for Matt Might's '3 shell scripts that can improve your writing'
